...
MenuState::MenuState(std::queue<std::pair<StateChange, StateID>>& pendingChanges)
	...
	buttons.insert({ "Play", Button("Play!", {100.0f, 75.0f}, {GlobalData::TRUE_WIDTH / 2, GlobalData::TRUE_HEIGHT / 5 * 2}, sf::Color::Red) });
	buttons.insert({ "Settings", Button("Settings", {100.0f, 75.0f}, {GlobalData::TRUE_WIDTH / 2, GlobalData::TRUE_HEIGHT / 5 * 3}, sf::Color::Blue) });
	buttons.insert({ "Exit", Button("Exit", {100.0f, 75.0f}, {GlobalData::TRUE_WIDTH / 2, GlobalData::TRUE_HEIGHT / 5 * 4}, sf::Color::Green) });
}
